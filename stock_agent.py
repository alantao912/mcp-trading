...
def find_trending_stocks_data():
    ...
    prompt = "What are the top 10 trending stocks in the US market right now? USE SEARCH TOOL to find the data. Include the company name, ticker symbol, and a brief reason for why each is trending. Just give me what you have. it not important"
